...
<head>
    ...
    define('bankName', 'Bank of Spark Foundation',true);
...
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Bank of Spark Foundation's</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
